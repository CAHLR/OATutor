# Writes all hints to 'translation-text-files/pre-translation/scrapedHints.txt'

import os
import json

# Retrieve filepath of all files with DefaultPathway in content-pool directory
output_file = 'src/math-to-speech/translation-text-files/pre-translation/scraped-hints/scrapedHints.txt' 
