...
/**
 * Split raw text (may contain LaTeX) into sentences for highlight mapping.
 * Splits on \n and sentence-ending punctuation followed by whitespace.
 * LaTeX expressions ($$...$$) never contain these patterns, so splitting is safe.
 */
