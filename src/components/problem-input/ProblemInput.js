...
class ProblemInput extends React.Component {
    ...
    constructor(props) {
        ...
        this.finalAnswerAreaRef = props.finalAnswerAreaRef;
    ...
    render() {
        ...
        console.log("this problem: ", problemType, this.props.step.answerType);
        ...
        return (
            ...
            >
                ...
                <Grid item xs={9} md={problemType === "TextBox" ? 3 : 12}>
                    ...
                    {problemType === "TextBox" &&
                        this.props.step.answerType === "short-essay" && (
                            <textarea
